...
\begin{resume}
	...
	Mayerhoffer, Daniel, Scheller, Simon, Schulz, Moritz and \textbf{Schulz, Jan}: ``Polarisation through Homophily. A Generative Algorithm''. \textit{Network Science}. In print. 
	...
	\textbf{Schulz, Jan}: ``Local and Global Inequality Rankings under Social Sampling''. Submitted to \textit{Economic Theory}.
