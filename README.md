# Jan Schulz-Gebhard academic website

Static GitHub Pages website. No build system is required.

## Main pages

- `index.html` - About / home
- `research.html` - Publications, manuscripts and Work in Progress
- `projects.html` - Funded projects and grants
- `conferences.html` - Workshops, special sessions and research schools
- `teaching.html` - Teaching
- `media.html` - Media appearances, videos, code and resources
- `service.html` - Editorial, institutional and professional service / memberships
- `cv.html` - CV
...
Upload the contents of this folder to the root of a GitHub repository and enable GitHub Pages from the main branch/root directory.
